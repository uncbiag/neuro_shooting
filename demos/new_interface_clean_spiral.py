    ...
    if args.viz:
        ...
        if not is_odenet:
            ...
            if is_higher_order_model:
                ...
                temp_pred_y = shooting(viz_time,z_0)
                # todo: make this work with everything again
...
if __name__ == '__main__':
    ...
    for itr in range(0, args.niters):
        ...
        if is_odenet:
            ...
            temp_pred_y = shooting(batch_t, z_0)
            # todo: make this work with the initial blocks
        ...
        if itr % args.test_freq == 0:
            ...
            if is_odenet:
                ...
                temp_pred_y = shooting(val_t, val_z_0)
                # todo: make this work with the initial blocks
