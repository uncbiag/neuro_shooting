...
for current_model in check_models:
    ...
    if current_model=='simple':
        ...
        shooting_model = shooting_models.AutoShootingIntegrandModelUpDown(in_features=1, nonlinearity='relu', nr_of_particles=10,
                                                          use_analytic_solution=True,
                                                          particle_dimension=1, particle_size=1, parameter_weight=0.1,
                                                          inflation_factor=5)
